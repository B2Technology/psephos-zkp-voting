export enum PshAnswerProtocolEnum {
  ...
  /**
   * Encripta o voto com a chave pública da eleição, no padrão RSA
   ...
   */
  Plaintext = "Plaintext", // TODO implements
}
...
export enum PshIdentityProtocolEnum {
   ...
   */
  Semaphore = "Semaphore", // TODO implements

  /**
   * O ID do eleito é encriptado com a chave pública da eleição usando ElGamal
   * Apenas o servidor de votação tera acesso a essa informação, para poder validar se é um ID valido
   */
  ElGamal = "ElGamal", // TODO implements

  /**
   * segredo é transformado em SHA256 ex: `sha256(secret + : + election_uuid)`
   */
  Sha256 = "Sha256", // TODO implements
